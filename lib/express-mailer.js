...
exports.extend = function (app, options) {
  ...
  var mailer = {},
      ...
      smtpTransport = nodemailer.createTransport(Object.assign(options, { transportMethod })),
      stubTransport,
      sendMail,
      createRender,
      createSend;
  ...
  createRender = function (render) {
    return function (sendOptions, locals, callback) {
      if (!stubTransport) {
        ...
        stubTransport = nodemailer.createTransport(Object.assign(options, { transportMethod: 'Stub' }));
      };
